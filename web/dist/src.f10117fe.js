...
function () {
  ...
  ApiSync.prototype.fetch = function (id) {
    return _axios.default.get(this.rootUrl + "/" + id);
  };
  ...
  ApiSync.prototype.save = function (data) {
    ...
    if (id) {
      return _axios.default.put(this.rootUrl + "/" + id, data);
    } else {
      return _axios.default.post(this.rootUrl, data);
    }
  };
...
function () {
  function Attributes(data) {
    ...
    this.data = data; //bound function - instance of attributes
...
exports.User = User;
},{"./ApiSync":"src/models/ApiSync.ts","./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./Eventing":"src/models/Eventing.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
